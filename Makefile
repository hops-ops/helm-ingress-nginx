...
PACKAGE ?= helm-ingress-nginx
XRD_DIR := apis/ingressnginxs
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/ingressnginxs/standard.yaml
...
EXAMPLES := \
    examples/ingressnginxs/minimal.yaml:: \
    examples/ingressnginxs/standard.yaml::
...
render\:%:
	@example="examples/ingressnginxs/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
